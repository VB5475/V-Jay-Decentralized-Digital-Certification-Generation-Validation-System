...
const Gov = () => {
  ...
  return (
    ...
    <div className="mainbody flex-col items-center justify-center h-screen">
      ...
      <div className="past-contract flex-col space-x-10 h-96 mt-10 justify-center items-center bg-purple-300 m-5 rounded-lg">
        ...
        <div className='text-center pb-16'>For Government Organizations</div>

        <div className='flex space-x-40 justify-center items-center h-[100%'>

         <button className='text-white bg-blue-600 font-medium text-xl p-3 rounded-lg mt-5 px-10' onClick={()=>{navigate('aadhardetail')}}>UIDAI AADHAR</button>
         <button className='text-white bg-blue-600 font-medium text-xl p-3 rounded-lg mt-5 px-10' onClick={()=>{navigate('Pandetail')}}>NSDL PAN</button>
         <button className='text-white bg-blue-600 font-medium text-xl p-3 rounded-lg mt-5 px-10'>LICENCE</button>
